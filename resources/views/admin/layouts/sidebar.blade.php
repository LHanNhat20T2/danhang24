    ...
    <ul class="navbar-nav navbar-right">
        ...
        <li class="dropdown"><a href="#" data-toggle="dropdown"
                ...
                <img class="mr-1 rounded-circle"
                    src="{{ !empty($profileData->avatar) ? url('upload/admin_images/' . $profileData->avatar) : url('upload/no_image.jpg') }}"
        ...
        <ul class="sidebar-menu">
            ...
            <li class="dropdown active">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="nav-link" href="{{ route('admin.orders.index') }}">Đơn đặt hàng</a></li>
                </ul>
            </li>
            ...
            <li class="dropdown active">
                ...
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="#!">Sơ đồ bàn</a></li>
                    <li><a class="nav-link" href="{{ route('admin.booking.index') }}">Lịch đặt bàn</a></li>
                </ul>
            </li>
            ...
            <li class="dropdown active">
                ...
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="#!">Khách hàng</a></li>
                    <li><a class="nav-link" href="#!">Nhân viên</a></li>
                </ul>
            </li>
            ...
            <li class="dropdown active">
                ...
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="{{ route('payment-setting.index') }}">Thanh toán</a></li>
                </ul>
            </li>
            ...
            {{-- <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{ route('admin.delivery-area.index') }}">Quản lý thanh toán</a>
                </li>
            </ul>
            </li> --}}
            ...
            {{-- <ul class="dropdown-menu">
                    <li><a class="nav-link" href="{{ route('admin.delivery-area.index') }}">Đơn vận chuyển</a></li>
                </ul> --}}
            {{-- </li> --}}
        </ul>
